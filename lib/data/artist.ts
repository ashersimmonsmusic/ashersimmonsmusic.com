...
export const artistProfile: ArtistProfile = {
  ...
  bioShort:
    "Asher Simmons is a Caribbean rapper, producer, sound engineer, songwriter and beatmaker, born in Dundas Town, Abaco, Bahamas and now based in Bristol, UK. His work moves between Hip-Hop and Afrobeat, with room to experiment beyond either.",
  bio: `Asher Simmons was born in Dundas Town, Abaco, in the Bahamas — an upbringing that runs underneath everything he makes, even after the move to Bristol, UK, where he is now based and where his sound has taken on the city's underground, DIY character.
