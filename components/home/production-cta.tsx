      ...
      <Container>
        <Reveal>
          <Link href="/production" className="group block">
            <p className="font-mono-label text-sun">Behind the board</p>
            <h2 className="font-display mt-4 flex flex-wrap items-center gap-4 text-4xl font-medium tracking-tight sm:text-6xl lg:text-7xl">
              ...
              Sound Engineering.
              <ArrowUpRight
                className="size-10 shrink-0 transition-transform duration-300 ease-[var(--ease-editorial)] group-hover:translate-x-2 group-hover:-translate-y-2 sm:size-14"
                aria-hidden
              />
            </h2>
