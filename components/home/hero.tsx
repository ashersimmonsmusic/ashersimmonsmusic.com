    ...
    <section className="relative overflow-hidden border-b border-line">
      <div className="grid lg:grid-cols-[1.05fr_0.95fr]">
        <div className="relative z-10 flex flex-col justify-center px-6 py-16 md:px-10 md:py-24 lg:py-20 lg:pr-10 lg:pl-16">
          <p className="font-mono-label text-eyebrow text-gold">Dundas Town, Abaco → Bristol, UK</p>

          <h1 className="font-display mt-6 text-[clamp(2.75rem,9vw,6.25rem)] text-balance-pretty">
            Asher
            <br />
            Simmons
          </h1>

          <p className="mt-8 max-w-md text-lg text-sea-mist md:text-xl">
          ...
          <div className="mt-10 flex items-center gap-4">
            ...
            <div>
              <p className="font-mono-label text-sea-mist">Now playing</p>
          ...
          <Link
            href="/about"
            className="font-mono-label mt-14 inline-flex items-center gap-2 self-start text-bone/70 hover:text-cobalt"
          >
            The story so far
        ...
        <div className="relative h-[75vw] max-h-[560px] lg:h-auto lg:max-h-none lg:min-h-[640px]">
          ...
          <div
            aria-hidden
            className="pointer-events-none absolute inset-x-0 top-0 h-24 bg-gradient-to-b from-navy to-transparent lg:hidden"
          />
          <div
            aria-hidden
            className="pointer-events-none absolute inset-y-0 left-0 hidden w-24 bg-gradient-to-r from-navy to-transparent lg:block"
          />
        </div>
      </div>
    </section>
